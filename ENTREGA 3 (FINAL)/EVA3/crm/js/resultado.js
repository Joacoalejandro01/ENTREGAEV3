...
fetch("http://144.126.210.74:8080/api/resultado", requestOptions)
    ...
    if(response.status == 200) {
      setTimeout(() => {
        ...
        mostrarAlerta('success', 'Tipo Gestion agregada exitosamente.');
...
function completarEtiqueta(element,index,arr){
    ...
    document.getElementById('lbl_eliminar').innerHTML ="Desea eliminar el tipo de gestion <b>" + nombre_resultado + "</b>";
